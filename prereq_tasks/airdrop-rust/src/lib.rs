...
#[cfg(test)] mod tests {
    ...
    use solana_sdk;
    use solana_sdk::{message::Message, signature::{Keypair, Signer, read_keypair_file}, pubkey::Pubkey, transaction::Transaction};
    use bs58;
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("8Jwcot83CBXzAj1a7HEn1C8F6yymstKNjxUBpUEyRYqz").unwrap();
    ...
    fn complete_prereq() {
        ...
        let args = CompleteArgs {
            github: b"AdedejiAdetola".to_vec(),
        };
        ...
        let transaction = Turbin3PrereqProgram::complete(
            &[&signer.pubkey(), &prereq, &solana_program::system_program::id()],
            &args,
            Some(&signer.pubkey()),
            &[&signer],
            blockhash,
